  ...
  return (
    <div className="flex flex-col items-center justify-center max-sm:overflow-hidden">
      <div className="flex  overflow-hidden ">
        <div className="flex flex-col justify-start w-full translate-x-20 xl:translate-x-48 max-w-[1086px] max-sm:max-w-[300px]  max-sm:translate-x-1 max-md:ml-0 max-md:w-full ">
          <div
            className="px-5 py-5 mt-5 xl:mt-20 max-md:mt-10  max-md:w-full overflow-hidden "
            ref={emblaRef}
          >
