  ...
  return (
    <section className="pt-24">
      <div className="max-container px-4">
        <div className=" flex w-full overflow bg-black justify-center relative rounded-md p-12 z-1 ">
          <motion.div
            initial={{ y: -1000 }}
            animate={{ y: 0 }}
            transition={{
          ...
          <div className="flex flex-col items-start justify-between w-[17%] max-md:ml-0 max-md:w-full">
            <div className=" text-white max-md:mt-10">
              ...
              <div className="flex gap-3 mr-28 px-4 py-3 mt-60 text-lg leading-7 bg-blue-700 rounded-[30px] text-stone-50 max-md:px-5 max-md:mt-10">
                <div className="flex-auto">Learn More</div>
              </div>
            </div>
          </div>
          <div className=" flex-1  ml-5 w-[83%] py-5 max-md:ml-0 max-md:w-full">
            <div className=" gap-24 items-center justify-center flex">
              {roadmaps.map((roadmap) => (
                <div
                  key={roadmap.title}
                  className="flex items-center bg-white  py-4 pl-[15px] pr-8 rounded-lg gap-7 relative min-w-64"
                >
                  ...
                  <div className=" flex-1  text-base font-medium ">
                    <h4 className="text-cyan-500 text-base">{roadmap.title}</h4>
                    <p className=" text-slate-500">{roadmap.subtitle}</p>
                  </div>
                </div>
              ))}
            </div>
            <div className=" mt-20 py-5 pl-12 gap-[100px] items-center justify-center flex">
              <div className="flex items-center bg-white  py-4 pl-[15px] pr-8 rounded-lg gap-7 relative min-w-64">
            ...
            <div className=" mt-20 gap-[100px] items-center justify-center flex">
              <div className="flex items-center bg-white  py-4 pl-[15px] pr-8 rounded-lg gap-7 relative min-w-64">
